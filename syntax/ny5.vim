...
syn keyword ariIns incm decm addm xorm andm orm mvam mvma mvrm mvlr addl xorl andl orl mvla mvat mvta rstc setc inca deca
" Conditional Instructions
syn keyword conIns cpam cpmz cpal cpcz cpzz
" Data Audio Instructions
syn keyword audIns chno chmd chtcs ldtm rbvp lden rben stop stpl play mmode
" Other Instructions
syn keyword othIns mpg rbro jmp call iret ldpc rbpc halt slow nop

syn keyword ny5regD rpt0 rpt1 rpt2 rpt3 rpt4 rpt5 xmd rod1 rod2

syn keyword ny5regT vol pflg int mix aud pa pb pc pd pe pf
...
hi def link ny5regD	SpecialKey
hi def link ny5regT	SpecialKey

""""""""""""""""""""""""""""""""""""""""""""""""""

let b:current_syntax = "ny5"
